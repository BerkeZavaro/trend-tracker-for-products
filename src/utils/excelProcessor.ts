...
export const columnMappings = {
  ...
  adjustedCpa: ['ADJUSTED CPA', 'Adjusted CPA', 'adjusted cpa', 'Adjusted_CPA', 'adjusted_cpa', 'AdjustedCPA', 'Adj CPA', 'adj cpa', 'ADUSTED CPA', 'Adusted CPA', 'adusted cpa', 'ADUSTED_CPA', 'adusted_cpa']
};
